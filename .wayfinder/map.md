...
| **Kotlin port, module 1 real and verified** | `android/app/src/main/kotlin/com/arogyax/signal/` — filters, Pan-Tompkins, RR features, SQI, all line-for-line ports of the Dart source. `gradle testDebugUnitTest` against the exact same golden vectors: 4/4 passing, 1e-6 tolerance, exact R-peak indices. See ticket 019 |
